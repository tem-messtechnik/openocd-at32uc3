...
#define AVR32_INST_SAMPLE_PRELOAD		0x02
#define AVR32_INST_EXTEST		0x03
#define AVR32_INST_INTEST		0x04
#define AVR32_INST_CLAMP		0x06
#define AVR32_INST_AVR_RESET	0x0c
#define AVR32_INST_CHIP_ERASE	0X0f

#define AVR32_INST_NEXUS_ACCESS	0x10
#define AVR32_INST_MW_ACCESS	0x11
#define AVR32_INST_MB_ACCESS	0x12
#define AVR32_INST_CANCEL_ACCESS 0x13

#define AVR32_INST_SYNC		0x17

#define AVR32_INST_HALT		0x1C
#define AVR32_INST_BYPAS	0x1F
